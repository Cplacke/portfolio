        ...
        return (
            <div className="relative">
                <div className="text-left m-auto mb-20 w-3/4 lg:w-3/5 block">
                    ...
                    <WorkHistory className="text-right ml-auto mr-0" 
                        item="Food &amp; Beverage" role="Server / Bartender" 
                        years="2011 - 2018"
                        icon="./assets/icons/dinner.svg" iconRight
                        ...
                        These are things I was alway wanting to from Rolling Burritos, Food Expediting, Serving Etiquette, Bartending, Craft Beer knowledge, 
                    ...
                    <WorkHistory className="" 
                        ...
                        to it naturally and was more satisfying to me than successfully running code solving your problems in milliseconds in front of your eyes. With a superb
                        suite of professors (Yiming Ji, Ph.D.; Brian Canada, Ph.D.; Xuwei Liang, Ph.D.; and Xiaomei Zhang Ph.D. to name a few) and the sense of comradery in 
                    ...
                    <WorkHistory className="text-right ml-auto mr-0"
                        ...
                        years="2016 - 2018"
                        icon="./assets/icons/screwdriver.svg" iconRight
                        ...
                        cheap, people willing to pay, and that I enjoyed taking the things apart and making it whole again. I created a network and a reputation with my classmates, co-workers, and as well
                    ...
                    <WorkHistory className="" 
                        ...
                        years="Summer 2017"
                        icon="./assets/icons/idea.svg" iconLeft
                        content="In the summer between my Senior semesters I had known that this was my best opportunity to secure and work an internship and find out what
                        ...
                        I was invited to take part part the the Technology Development Program (TDP) for college students and recent graduates; an 80+ student class of interns from around the country 
                    ...
                    <WorkHistory className="text-right ml-auto mr-0" 
                        ...
                        years="2018 - Current"
                        icon="./assets/icons/briefcase.svg" iconRight
